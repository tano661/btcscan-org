...
NGINX_CSP="default-src 'self' *.google-analytics.com *.analytics.google.com *.googletagmanager.com; script-src 'self' 'unsafe-eval' 'unsafe-inline' *.google-analytics.com *.analytics.google.com *.googletagmanager.com https://ssl.google-analytics.com; img-src 'self' 'unsafe-inline' *.google-analytics.com *.analytics.google.com *.googletagmanager.com data:; style-src 'self' 'unsafe-inline'; font-src 'self' data:; object-src 'none'"
